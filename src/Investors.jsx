    ...
    <>
      ...
      <main>
        ...
        <div className="bg-body-tertiary py-2">
          ...
          <div className="container">
            ...
            <nav aria-label="breadcrumb">
              {/* breadcrumb cần danh sách .breadcrumb */}
              <ol className="breadcrumb mb-0 small">
                {/* breadcrumb: style đường dẫn; mb-0: bỏ margin dưới; small: giảm font-size */}
        ...
        <section className="hero-section">
          {/* TUỲ CHỈNH: khối hero riêng của trang IR */}
          <div className="container">
            <div className="hero-card row g-0 align-items-center shadow-sm">
              {/* row: kích hoạt lưới; g-0: bỏ gutter; align-items-center: căn giữa theo trục dọc; shadow-sm: bóng nhẹ; hero-card: TUỲ CHỈNH */}
              <div className="col-lg-7">
                {/* cột trái chiếm 7/12 từ ≥992px; dưới lg tự full width */}
                <div className="hero-img"></div>
                {/* TUỲ CHỈNH: vùng hình nền/ảnh minh hoạ */}
              </div>
              <div className="col-lg-5">
                {/* cột phải 5/12 từ ≥992px */}
                <div className="hero-content">
                  {/* TUỲ CHỈNH: nội dung hero */}
                  <span className="badge bg-light text-dark mb-3">Quan hệ Nhà đầu tư</span>
                  {/* badge: huy hiệu nhỏ; bg-light + text-dark: nền sáng, chữ tối; mb-3: 1rem */}
                  <h1 className="display-5 fw-bold mb-3">Khung Tài chính bền vững</h1>
                  {/* display-5: heading cỡ lớn; fw-bold: đậm; mb-3: cách dưới */}
                  ...
                  {/* lead: đoạn nhấn mạnh (font to & màu nhạt hơn); text-secondary: màu phụ; mb-4: 1.5rem */}
                  <a className="btn-hero" href="#">
                    {/* TUỲ CHỈNH: nút phong cách riêng; nếu muốn dùng BS: .btn .btn-primary */}
                    <span>Đọc thêm</span>
                    <span className="circle">
                      <i className="bi bi-chevron-right"></i>
                    </span>
                    {/* .bi: icon font; .bi-chevron-right: tên icon */}
                  </a>
                </div>
              </div>
            </div>
        ...
        <section className="py-5">
          {/* py-5: padding dọc 3rem tạo nhịp phân đoạn */}
          <div className="container">
            <div className="d-flex align-items-end justify-content-between flex-wrap gap-3 mb-4">
              {/* d-flex: bật flex; align-items-end: căn đáy theo trục dọc; justify-content-between: 2 đầu; flex-wrap: cho phép xuống dòng; gap-3: khoảng cách giữa items 1rem; mb-4: 1.5rem */}
              <div>
                <h2 className="section-title mb-1">Báo cáo định kỳ</h2>
                {/* section-title: TUỲ CHỈNH; mb-1: 0.25rem */}
                <p className="text-secondary mb-0">
                  Tổng hợp các báo cáo Quản trị, Tài chính, Thường niên, Phát triển bền vững…
                </p>
                {/* text-secondary: màu phụ; mb-0: bỏ khoảng dưới */}
              </div>
              <a href="#" className="btn btn-outline-primary">
                Tất cả báo cáo
              </a>
              {/* btn: nút; btn-outline-primary: viền + chữ màu primary, nền trong */}
            </div>

            <div id="reportsCarousel" className="carousel slide" data-bs-ride="false">
              {/* carousel slide: kích hoạt component Carousel; data-bs-ride="false": không tự chạy */}
              {/* dots */}
              <div className="carousel-indicators position-static my-3">
                {/* carousel-indicators: chấm điều hướng; position-static: đứng yên (mặc định indicators là absolute); my-3: margin trục dọc 1rem */}
              ...
              <div className="carousel-inner">
                {/* vùng chứa các .carousel-item; 1 item sẽ có .active */}
                {reportSlides.map((slide, sIdx) => (
                  ...
                  >
                    ...
                    <div className="row g-4 row-cols-1 row-cols-lg-3">
                      {/* row-cols-1: tự chia 1 cột/row dưới lg; row-cols-lg-3: 3 cột/row từ ≥992px; g-4: gutter 1.5rem */}
                      {slide.map((card, cIdx) => (
                        <div className="col" key={cIdx}>
                          {/* col: cột tự mở rộng đều trong cơ chế row-cols */}
                          <div className="report-tile h-100">
                            {/* report-tile: TUỲ CHỈNH; h-100: cao 100% để các thẻ bằng chiều cao */}
                            <img className="cover" src={card.src} alt={card.alt} />
                            {/* cover: TUỲ CHỈNH (thường object-fit:cover) */}
                            <div className="meta">
                              {/* TUỲ CHỈNH: vùng mô tả */}
                              <div className="title">{card.title}</div>
                              <a className="cta link-primary" href={card.href}>
                                Xem chi tiết <i className="bi bi-chevron-right"></i>
                              </a>
                              {/* link-primary: màu link theo --bs-primary */}
                            </div>
                          </div>
                        </div>
                      ))}
              ...
              <button
                ...
                data-bs-slide="prev"
              >
                {/* nút lùi slide; data-bs-slide="prev" kích hoạt JS */}
                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                {/* icon mũi tên (background-image) */}
        ...
        <section className="py-5 bg-body-tertiary">
          {/* bg-body-tertiary: khối nền sáng để tách nội dung */}
          <div className="container">
            ...
            <div className="panel-xl shadow-0">
              {/* panel-xl: TUỲ CHỈNH; shadow-0: KHÔNG PHẢI class BS, nếu muốn bỏ bóng dùng .shadow-none */}
              <div className="row g-4 align-items-start">
                {/* g-4: 1.5rem; align-items-start: căn đầu theo trục dọc */}
                {/* Cột trái: bộ lọc năm + danh mục dạng pill */}
                <aside className="col-lg-4">
                  {/* col-lg-4: 4/12 từ ≥992px; semantic <aside> cho vùng phụ trợ */}
                  <div className="side-filter">
                    {/* TUỲ CHỈNH: khối lọc */}
                    <div className="mb-3">
                      {/* mb-3: 1rem khoảng cách dưới */}
                      <div className="label-caption mb-1">Năm</div>
                      {/* TUỲ CHỈNH: nhãn */}
                      <YearSelect id="agmYear" />
                    </div>
                    <div className="pill-nav mt-3">
                      {/* TUỲ CHỈNH: điều hướng dạng pill */}
                      <button type="button" className="btn btn-primary active">
                        Thông báo và thư mời
                      </button>
                      {/* btn btn-primary: nút chủ đạo; active: trạng thái đang chọn (style đậm) */}
                      <button type="button" className="btn btn-light disabled">
                        Tài liệu họp
                      </button>
                      {/* disabled: vô hiệu; với <button> là đủ, với <a> cần .disabled + aria-disabled */}
                      <button type="button" className="btn btn-light disabled">
                ...
                <div className="col-lg-8">
                  ...
                  <div className="items-wrap">
                    {/* TUỲ CHỈNH: bao danh sách */}
                    {agmItems.map((it, idx) => (
                      <div className="item-row" key={idx}>
                        {/* TUỲ CHỈNH: một hàng mục; nên đặt display:flex trong CSS */}
                        <div className="flex-grow-1">
                          {/* flex-grow-1: phần này chiếm hết không gian còn lại */}
                          <div className="title">{it.title}</div>
                        </div>
                        <a className={it.btnClass} href="#">
                          Tải xuống <i className="bi bi-download"></i>
                        </a>
                        {/* btn-download: TUỲ CHỈNH; icon tải xuống */}
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <aside className="col-lg-4">
                  <div className="side-filter">
                    <div className="mb-3">
                      ...
                      {/* form-select: input chọn dạng BS */}
                    </div>
                    <div className="pill-nav mt-3">
        ...
        {/* Disclosures */}
        <section className="py-5 bg-body-tertiary">
          {/* tông nền phụ để tách nhóm nội dung */}
          <div className="container">
        ...
        <section className="py-5">
          {/* lặp lại nhịp spacing đồng nhất */}
          <div className="container">
        ...
        <section className="py-5 bg-body-tertiary">
          {/* bg-body-tertiary: tách khối liên hệ */}
          <div className="container">
            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
              {/* căn giữa theo trục dọc + chia 2 đầu + cho phép wrap + khoảng cách */}
              ...
              <a
                ...
                rel="noopener"
              >
                {/* btn-pill: TUỲ CHỈNH (nếu muốn BS chuẩn dùng .rounded-pill) */}
                Chỉ đường{' '}
                <span className="circle">
                  <i className="bi bi-chevron-right"></i>
                </span>
            ...
            <div className="row g-4">
              <div className="col-lg-7">
                {/* 7/12 từ ≥992px; dưới lg sẽ full width và nằm trên */}
                <div className="p-4 bg-white rounded-3 shadow-sm h-100">
                  {/* p-4: 1.5rem; bg-white: nền trắng; rounded-3: bo góc vừa; shadow-sm; h-100: cao bằng cột đối diện */}
                  <ul className="list-group list-group-flush info-list">
                    {/* list-group: nhóm danh sách kiểu card; list-group-flush: bỏ viền/bo tròn ngoài */}
                    {contactList.map((row, idx) => (
                      <li
                        className="list-group-item d-flex align-items-start gap-3"
                        key={idx}
                      >
                        {/* list-group-item: phần tử danh sách chuẩn; d-flex: đặt icon & text cùng hàng; align-items-start: căn đỉnh; gap-3: 1rem */}
              ...
              <div className="col-lg-5">
                ...
                <div className="p-4 bg-white rounded-3 shadow-sm h-100">
                  ...
                  {/* me-2: margin-end .5rem cách icon-số */}
                  <p className="mb-0">
            ...
            <div className="panel-xl">
              <form>
                <div className="row g-3">
                  {/* g-3: 1rem khoảng cách giữa các ô input */}
                  {subscribeFields.map((f, idx) => (
                    <div className="col-md-4" key={idx}>
                      {/* 4/12 từ ≥768px; dưới md full width */}
                      <label className="form-label small text-uppercase text-secondary fw-semibold">
                        {f.label}
                      </label>
                      {/* form-label: style nhãn; small: cỡ nhỏ; text-uppercase: in hoa; text-secondary: màu phụ; fw-semibold: đậm 600 */}
                      <input
                        type={f.type}
                        ...
                        required
                      />
                      {/* form-control: style input chuẩn; input-soft: TUỲ CHỈNH */}
                    </div>
                  ))}
                  <div className="col-12 d-flex gap-3 mt-2">
                    {/* col-12: full width; d-flex: xếp nút & ghi chú cùng hàng; gap-3: 1rem; mt-2: 0.5rem */}
                    <button type="submit" className="btn btn-primary btn-pill">
                      Gửi yêu cầu
                    </button>
                    {/* btn-pill: TUỲ CHỈNH bo viên; dùng .rounded-pill nếu theo BS */}
